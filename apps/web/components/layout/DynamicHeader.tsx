...
export default function DynamicHeader() {
  ...
  const headerMap: Record<string, { title: string; sub?: string }> = {
    ...
    '/projects': { title: 'Project Management', sub: 'List of all active projects' },
    '/upload': { title: 'Upload Data', sub: 'Import Excel files' },
  };
  ...
  return (
    ...
    >
      ...
      {/* Kanan: Actions (Sesuai Gambar Baru) */}
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-2 pl-2 cursor-pointer group">
          ...
          <ChevronDown size={16} className="text-[#1B1C1F] group-hover:text-gray-600" />
        </div>
      </div>
    </header>
  );
